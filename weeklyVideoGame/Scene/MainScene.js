class MainScene extends Scene {
  constructor() {
    ...
    this.instantiate(new PlatformGameObject(150, 20), new Vector2(350, 530));
    this.instantiate(new PlatformGameObject(200, 20), new Vector2(600, 460));
    this.instantiate(new PlatformGameObject(100, 20), new Vector2(850, 390));
    ...
    //Enemies
    let enemy1GameObject = this.instantiate(new BasicEnemyGameObject(50), new Vector2(300, 460))
    ...
    let enemy2GameObject = this.instantiate(new BasicEnemyGameObject(70), new Vector2(850, 360))
    ...
    let enemy4GameObject = this.instantiate(new BasicEnemyGameObject(70), new Vector2(600, 360))
    ...
    let projectileEnemeyGameObject = this.instantiate(new ProjectileEnemyGameObject(), new Vector2(-100, 600))
    let projectileEnemeyHealthBarGameObject = this.instantiate(new HealthBarGameObject(projectileEnemeyGameObject), new Vector2(0, -20/projectileEnemeyGameObject.transform.scale.y));
    projectileEnemeyHealthBarGameObject.transform.setParent(projectileEnemeyGameObject.transform)

    let fallingEnemyGameObject = this.instantiate(new FallingEnemyGameObject(), new Vector2(650, 480))
    let fallingEnemyHealthBarGameObject = this.instantiate(new HealthBarGameObject(fallingEnemyGameObject), new Vector2(0, -20/fallingEnemyGameObject.transform.scale.y));
    fallingEnemyHealthBarGameObject.transform.setParent(fallingEnemyGameObject.transform)
  }
}
